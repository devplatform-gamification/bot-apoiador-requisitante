...
@Component
public class Documentation03CheckAutomaticHomologation extends Handler<JiraEventIssue>{

	private static final Logger logger = LoggerFactory.getLogger(Documentation03CheckAutomaticHomologation.class);
