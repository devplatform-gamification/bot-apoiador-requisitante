...
//		this.markdown = markdown;
		...
		if(releaseNotes != null && releaseNotes.getVersion() != null && releaseNotes.getVersionType() != null && StringUtils.isNotBlank(releaseNotes.getUrl())) {
			...
			markdownText.append(markdown.newLine())
				.append(markdown.link(releaseNotes.getUrl(), "Acesse o release notes completo desta versão aqui"));
		}
